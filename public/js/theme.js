...
(function () {
    ...
    var Core = {
        ...
        initSlider: function (options) {
            var minValue = parseInt($("#minUsados").val());
            var maxValue = parseInt($("#maxUsados").val());
            $(".slider").each(function (i) {
                var $slider = $(this),
                        isSlider = $slider.length;

                if (isSlider) {
                    var minVal = $slider.data('min-val') ? $slider.data('min-val') : minValue,
                            maxVal = $slider.data('max-val') ? $slider.data('max-val') : maxValue;
//                    var minVal = minValue,
//                            maxVal = maxValue;
